    ...
    def INPUT_TYPES(cls) -> Dict[str, Any]:
        return {
            "required": {
                ...
                "contributor_topk": (IO.INT, {"default": 0, "min": 0, "max": 500, "step": 1, "tooltip": "Top-K for 'contributor' (very sparsely populated — low utility). 0 with threshold 0.0 = use global."}),
                "contributor_threshold": (IO.FLOAT, {"default": 0.0, "min": 0.0, "max": 1.0, "step": 0.001, "display": "slider", "tooltip": "Threshold for 'contributor' (very sparsely populated — low utility). 0.0 with topk 0 = use global."}),
                "unassigned_topk": (IO.INT, {"default": 0, "min": 0, "max": 500, "step": 1, "tooltip": "Top-K for 'unassigned' (tags with no category assignment in the vocab — low utility). 0 with threshold 0.0 = use global."}),
                "unassigned_threshold": (IO.FLOAT, {"default": 0.0, "min": 0.0, "max": 1.0, "step": 0.001, "display": "slider", "tooltip": "Threshold for 'unassigned' (tags with no category assignment in the vocab — low utility). 0.0 with topk 0 = use global."}),
            }
        }
    ...
    def INPUT_TYPES(cls) -> Dict[str, Any]:
        ...
        return {
            "required": {
                ...
                "exclude_categories": (IO.STRING, {"multiline": False, "default": "contributor, unassigned", "tooltip": "Comma-separated categories to exclude: unassigned, general, artist, contributor, copyright, character, species, disambiguation, meta, lore."}),
