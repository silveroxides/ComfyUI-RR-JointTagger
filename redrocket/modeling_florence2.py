...
class Florence2EncoderLayer(nn.Module):
    def __init__(self, config: Florence2LanguageConfig):
        ...
        self.self_attn = FLORENCE2_ATTENTION_CLASSES[attn_impl](
...
class Florence2DecoderLayer(nn.Module):
    def __init__(self, config: Florence2LanguageConfig):
        ...
        self.self_attn_layer_norm = nn.LayerNorm(self.embed_dim)
        self.encoder_attn = FLORENCE2_ATTENTION_CLASSES[attn_impl](
            self.embed_dim,
...
class Florence2LanguagePreTrainedModel(nn.Module):
...
class Florence2PreTrainedModel(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
